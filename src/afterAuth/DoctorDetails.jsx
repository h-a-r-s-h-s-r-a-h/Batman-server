...
const DoctorDetails = () => {
  ...
  return (
    <div>
      ...
      <div id="main">
        <div className={style.doctorTemplate}>
          <h1>
          ...
          <p>Language Supportive : {Doctor.languageSpoken}</p>
          <p>Address : {Doctor.addressOfClinic}</p>
          <h2>Contact : {Doctor.email} </h2>
          <h2>{Doctor.mobile}</h2>
          <a
            activeClassName={`${style.active}`}
            href={`/doctor/appointment/${id}`}
