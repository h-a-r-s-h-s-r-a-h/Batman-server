        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <h1>MedicoMart: Your Trusted Healthcare Marketplace</h1>
              <h2>
                Your go-to for trusted medications and wellness products.
                Simplifying healthcare shopping with convenience and
                reliability.
              </h2>
                    ...
                    <tbody>
                      {currentMedicines.map((medicine) => (
                        <tr key={medicine.uniqueID}>
                          <th scope="row">{medicine.drugName}</th>
                          <td>{medicine.condition}</td>
                          <td>{medicine.rating}</td>
                          <td>{medicine.review}</td>
                          <td>
                            <Link to={`/MedicoDetails/${medicine.uniqueID}`}>
                              <button>Read</button>
                            </Link>
                          </td>
                        </tr>
