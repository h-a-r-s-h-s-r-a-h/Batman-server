...
const MentalBot = () => {
  ...
  const [fellingData, setFellingData] = useState([]);
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch("http://127.0.0.1:8001/mental_bot", {
      method: "POST",
      headers: {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <h1>EmoBot: Feel Better, Sound Better</h1>
              <h2>
                Meet EmoBot, your pocket-sized emotional support system. Share
                your feelings, and get instant solutions along with soothing
                music suggestions for stress relief.
              </h2>
              <div className="d-flex"></div>
            </div>
            <div className={`col-lg-6 order-1 order-lg-2 ${styles.heroimg}`}>
              <img src="/emobot.jpg" class="img-fluid animated" alt="" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div id="main">
        <section id="featured-services" className={styles.featuredservices8}>
          <form onSubmit={handleSubmit}>
            <div className="form-row">
              <div className="form-group col-md-10">
                <label for="inputEmail4">Express Your Fellings</label>
                <input
                  type="text"
          ...
          >
            ...
            <textarea
              value={fellingData.message}
              onChange={handleChange}
              style={{ width: "100%", height: "520px", resize: "none" }}
              disabled
            />
          </Popup>
        </section>
