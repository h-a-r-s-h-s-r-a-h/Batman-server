...
const PolicyRecommendation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // console.log(formData);
    const response = await fetch("http://127.0.0.1:8001/policy_recomendation", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      body: JSON.stringify({
        member_covered: formData.memberCovered,
        age: formData.age,
        coverage: formData.coverage,
        policy_tenure: formData.tenure,
        smoker: formData.smoker,
      }),
    });
    const data = await response.json();
    console.log(data);
    console.log(data.Policy1.Benifits);
    setPolicyData(data);
    toast.success("Your Policy is Ready!");
  };
  useEffect(() => {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
              <h1>Health Insurance Predictor: Plan Ahead with Precision</h1>
              <h2>
                In today's complex healthcare landscape, our Health Insurance
                Predictor empowers you to anticipate your future insurance needs
                with accuracy.
              </h2>
              <div className="d-flex"></div>
            </div>
            <div className={`col-lg-6 order-1 order-lg-2 ${styles.heroimg}`}>
              <img src="/insuranc1.jpg" class="img-fluid animated" alt="" />
            </div>
          </div>
        </div>
      </section>
      ...
      <div id="main">
        <section id="featured-services" className={styles.featuredservices8}>
          <form onSubmit={handleSubmit}>
            <div className="form-row">
              <div className="form-group col-md-10">
                <label for="inputEmail4">Member Covered</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputEmail4"
                  name="memberCovered"
                  placeholder="no of family members covered"
                  value={formData.memberCovered}
              ...
              <div className="form-group col-md-10">
                <label for="inputEmail4">Coverage</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputEmail4"
              ...
              <div className="form-group col-md-10">
                <label for="inputEmail4">Policy Tenure</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputEmail4"
              ...
              <div className="form-group col-md-10">
                <label for="inputEmail4">Smoker</label>
                <input
                  type="text"
                  className="form-control"
                  id="inputEmail4"
          ...
          >
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {PolicyData &&
                      PolicyData.Policy1 &&
                      PolicyData.Policy1.monthly_premium}
                  </td>
                </tr>
                <tr>
                  <th scope="row">Policy Tenure</th>
                  <td>
                    {PolicyData &&
                      PolicyData.Policy1 &&
                      PolicyData.Policy1.policy_tenure}
                  </td>
                </tr>
                <tr>
                  <th scope="row">Member Covered</th>
                  <td>
                    {PolicyData &&
                      PolicyData.Policy1 &&
                      PolicyData.Policy1.member_covered}
                  </td>
                </tr>
                <tr>
                  <th scope="row">Claim Reported</th>
                  <td>
                    {PolicyData &&
                      PolicyData.Policy1 &&
                      PolicyData.Policy1.claim_reported}
                  </td>
                </tr>
                <tr>
                  <th scope="row">Claim Outstanding</th>
                  <td>
                    {PolicyData &&
                      PolicyData.Policy1 &&
                      PolicyData.Policy1.claim_outstanding}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <textarea
              value={
                PolicyData && PolicyData.Policy1 && PolicyData.Policy1.Benifits
              }
              onChange={handleChange}
